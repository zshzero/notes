...
![Image represents the CAP theorem, visualized using three overlapping circles.  Each circle represents one of the three c](./images/2e9c1a3a_figure-6-1-D3AZLP5W.svg)
...
![Image represents a simple network topology diagram showing three nodes, labeled n1, n2, and n3, depicted as cylindrical ](./images/b7fa8196_figure-6-2-KZYRLJFF.svg)
...
![Image represents a simple network topology diagram showing three nodes, labeled n1, n2, and n3, depicted as cylindrical ](./images/5ef68edb_figure-6-3-3AXO446L.svg)
...
![Image represents a circular arrangement of eight nodes, labeled s0 through s7, connected by a gray line forming a ring. ](./images/76207dc8_figure-6-4-SVUGPDYI.svg)
...
![Image represents a circular arrangement of eight nodes, labeled s0 through s7, connected by a gray line forming a comple](./images/f4a94ec3_figure-6-5-NG3WIQQO.svg)
...
![Image represents a simplified distributed system architecture for data storage, likely a key-value store.  A central com](./images/4c835e73_figure-6-6-RNMG7AUI.svg)
...
![Image represents a simplified system architecture diagram illustrating data retrieval from two separate servers (server ](./images/dbcb805b_figure-6-7-MX7NGSSF.svg)
...
![Image represents a simplified system architecture diagram illustrating data insertion into two separate databases.  Two ](./images/a1cfe422_figure-6-8-WXAQYDBT.svg)
...
![Image represents a data flow diagram illustrating a data replication and reconciliation process.  A top-down flow begins](./images/79fd8288_figure-6-9-APUHGGQW.svg)
...
![Image represents a fully connected graph, or complete graph, of four nodes labeled S0, S1, S2, and S3, arranged cyclical](./images/7e2292c9_figure-6-10-U4WMW34H.svg)
...
![Image represents a system diagram showing a membership list and a ring topology network.  The top-left shows a partial m](./images/5742356e_figure-6-11-SHKPJFQN.svg)
...
![Image represents a simplified distributed system architecture, likely for a key-value store, depicted as a circular arra](./images/84191b93_figure-6-12-TCHVLATH.svg)
...
![Image represents a simplified diagram illustrating data partitioning across two servers, labeled 'server 1' and 'server ](./images/81052fb0_figure-6-13-2LCEPIWQ.svg)

*Figure 13*

Step 2: Once the buckets are created, hash each key in a bucket using a uniform hashing method (Figure 14).

![Image represents a simplified diagram illustrating data distribution across two servers, labeled 'server 1' and 'server ](./images/2271d790_figure-6-14-S2QAQ6NW.svg)

*Figure 14*

Step 3: Create a single hash node per bucket (Figure 15).

![Image represents a diagram illustrating a distributed system architecture with two servers, labeled 'server 1' and 'serv](./images/2ede129c_figure-6-15-I46TOGGB.svg)

*Figure 15*

Step 4: Build the tree upwards till root by calculating hashes of children (Figure 16).

![Image represents a diagram illustrating data distribution across two servers, labeled 'server 1' and 'server 2'. Each se](./images/279db177_figure-6-16-5GFGLUJW.svg)
...
![Image represents a system architecture diagram showing a client interacting with a distributed system.  A rectangular bo](./images/b0468e17_figure-6-17-727LAZC5.svg)
...
![Image represents a single node in a distributed system, depicted as a large circle labeled 'node'.  Inside this circle a](./images/6d0f401e_figure-6-18-VIXXZUFG.svg)
...
![Image represents a simplified architecture diagram of a write operation in a database system.  A `Client` sends a `Write](./images/979512aa_figure-6-19-L5VIQL76.svg)
...
![Image represents a system architecture diagram illustrating a read operation.  A light-blue rectangle labeled 'Client' i](./images/7d6f56df_figure-6-20-CMQ6VUZJ.svg)
...
![Image represents a system architecture diagram illustrating a read operation in a database system.  A client initiates a](./images/bb111b0f_figure-6-21-WBKMXPRG.svg)
