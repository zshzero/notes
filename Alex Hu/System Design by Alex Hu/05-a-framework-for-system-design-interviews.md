...
![Image represents a system architecture diagram showing the flow of a user request for a news feed.  A user, accessing vi](./images/629d7ffa_figure-3-1-ZIAGKIG7.png)

*Figure 1*

![Image represents a system architecture diagram for a news feed service.  A user, accessing via a web browser or mobile a](./images/694bcb97_figure-3-2-4TY6XZV7.png)
...
![Image represents a system architecture diagram for a news feed application.  A user, accessing via web browser or mobile](./images/883f2e57_figure-3-3-OEFRG37K.png)

*Figure 3*

![Image represents a system architecture diagram for a news feed service.  A user, accessing via web browser or mobile app](./images/3ef0d704_figure-3-4-4ZXFIXDU.png)
