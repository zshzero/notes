...
![Image represents a screenshot of the YouTube website's homepage.  The left side displays a vertical menu bar with option](./images/08aa2ae7_figure-14-1-POM4N7ME.png)
...
![Image represents a table displaying pricing for cloud storage, differentiated by geographic region and data volume tiers](./images/403c847f_figure-14-2-DVJHFDA4.png)
...
![Image represents a simplified system architecture diagram.  A light-blue rectangular box labeled 'Client' contains icons](./images/e1bc2f42_figure-14-3-S2A555CM.png)
...
![Image represents a system architecture diagram for video transcoding.  The process begins with a user (represented by ic](./images/652189c3_figure-14-4-ADSJBRI3.png)
...
![Image represents a system architecture diagram for video transcoding and delivery.  A user (accessing via TV, laptop, or](./images/ec563f28_figure-14-5-PWL5A5PM.png)
...
![Image represents a system architecture for managing metadata.  Users (represented by icons for TV, laptop, and mobile ph](./images/6d45148e_figure-14-6-IK5S43FH.png)
...
![Image represents a simple client-server architecture for streaming video.  A light-blue rectangular box labeled 'Client'](./images/5311e450_figure-14-7-25E4UND4.png)
...
![Image represents a data processing pipeline for video production.  An 'Original video' block feeds into two parallel pro](./images/4aac5497_figure-14-8-6TUJKWRP.svg)
...
![Image represents a simplified diagram of a video delivery system.  A central rectangular box labeled 'Video...' acts as ](./images/34dd4689_figure-14-9-363XWSRP.svg)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a 'Preprocessor' component, wh](./images/521377ec_figure-14-10-YWOCJMVV.svg)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a `Preprocessor` (light blue b](./images/4dba6a66_figure-14-11-VKQRKCM2.svg)
...
![Image represents a simplified data flow diagram showing a two-stage process.  The diagram consists of two rectangular bo](./images/89f55843_figure-14-12-FKWX3DRN.svg)

*Figure 12*

This DAG representation is generated from the two configuration files below (Figure 13):

![Image represents a pair of code snippets, likely depicting two sequential tasks within a workflow, possibly for video pr](./images/89903ae1_figure-14-13-LRTFEHXK.png)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a 'Preprocessor' component, wh](./images/b545408b_figure-14-14-TZNQCING.svg)
...
![Image represents a data processing pipeline managed by a DAG (Directed Acyclic Graph) scheduler.  The pipeline is divide](./images/64f6ea3e_figure-14-15-DBQMPINY.svg)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a `Preprocessor` which feeds d](./images/4f37dcb8_figure-14-16-D65ZJKSR.svg)
...
![Image represents a system for task scheduling and execution.  The system is composed of three main components: a Resourc](./images/96182a90_figure-14-17-RHMGJC6L.svg)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a 'Preprocessor' component, wh](./images/f22f3e25_figure-14-18-24OH4P2W.svg)
...
![Image represents a simplified architecture diagram of a task worker system, likely within a larger media processing pipe](./images/bf401c1d_figure-14-19-Y5ZPZAJT.svg)

*Figure 19*

#### Temporary storage

![Image represents a data processing pipeline for video encoding.  The pipeline begins with a 'Preprocessor' component, wh](./images/7ebf9b65_figure-14-20-VAG7ZAYZ.svg)
...
![Image represents a data processing pipeline for video encoding.  The pipeline begins with a 'Preprocessor' component, wh](./images/620a9e44_figure-14-21-AZ4TQFF2.svg)
...
![Image represents a process of splitting a video into smaller segments.  A rectangular box labeled 'Original video' conta](./images/611efc9c_figure-14-22-3EM25VLA.svg)
...
![Image represents a system architecture diagram illustrating data distribution from an original storage to multiple clien](./images/1f09cb18_figure-14-23-YQDZDVEV.png)
...
![Image represents a world map illustrating a distributed upload center architecture.  The map shows four colored regions ](./images/276893e1_figure-14-24-LIPZPHHR.svg)
...
![Image represents a video processing and distribution pipeline.  The process begins with an 'Original storage' block (a g](./images/c71ee7ae_figure-14-25-4VSMBFLW.svg)
...
![Image represents a system architecture diagram illustrating a media processing pipeline.  The process begins with 'Origi](./images/6460bb05_figure-14-26-DQ2B7KIJ.svg)
...
![Image represents a simplified system architecture for video uploading.  A user, represented by icons for a TV, laptop, a](./images/77ef6764_figure-14-27-GVQ6JW3A.png)
...
![Image represents a system architecture for video streaming.  A central 'User' block depicts a user accessing videos thro](./images/ba771bf4_figure-14-28-Q7VI7TYL.png)
