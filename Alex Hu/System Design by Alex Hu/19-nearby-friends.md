...
![Image represents a mobile application screen displaying a list of nearby friends.  The top displays the time (10:52), ba](./images/33aab1e3_figure-1-facebook-nearby-friends-XALOYO46.png)
...
![Image represents a network topology diagram showing a mesh network of seven mobile phones. Each phone is depicted as a s](./images/49079b6b_figure-2-peer-to-peer-TDFPCCFK.svg)
...
![Image represents a simplified system architecture diagram showing a user interacting with a backend system that communic](./images/cb12bf5f_figure-3-shared-backend-JI6MRFAF.svg)
...
![Image represents a system architecture diagram for a mobile application.  Mobile Users connect to a Load Balancer via HT](./images/07f3c282_figure-4-high-level-design-35BO5JE4.svg)
...
![Image represents a system architecture diagram for a mobile application.  Mobile Users connect to a Load Balancer via HT](./images/f1303d2b_figure-5-restful-api-request-flow-SL4EZ27Z.svg)
...
![Image represents a system architecture diagram illustrating a publish-subscribe (Pub/Sub) model using Redis.  The diagra](./images/7f995264_figure-6-redis-pub-sub-KDAMADYD.svg)
...
![Image represents a system architecture diagram for a mobile application.  Mobile Users connect to a Load Balancer via HT](./images/90ddcf15_figure-7-periodic-location-update-KBIO53BB.svg)
...
![Image represents a system architecture for real-time location sharing among friends using WebSockets and Redis Pub/Sub. ](./images/f863673b_figure-8-send-location-update-to-friends-DUUPBXZN.svg)
...
![Image represents a simplified architecture diagram illustrating a Redis Pub/Sub system.  Seven circles represent Redis P](./images/db5331cf_figure-9-consistent-hashing-LKSFU4ZN.png)
...
![Image represents a system design for location updates using Redis Pub/Sub and WebSockets.  On the left, a Redis Pub/Sub ](./images/4bc83695_figure-10-figure-out-the-correct-redis-pub-sub-server-2WS7WJK6.png)
...
![Image represents a consistent hashing ring before and after adding a new node.  The initial state shows a ring with four](./images/efa32815_figure-11-replace-pub-sub-server-CIN6EUJH.png)
...
![Image represents a system for geographically locating users.  The left side shows a map divided into four quadrants, eac](./images/8e56c30d_figure-12-redis-pub-sub-channels-AHZA4ALB.svg)
...
![Image represents a system architecture diagram illustrating real-time location updates using Redis Pub/Sub.  On the left](./images/0fd469ef_figure-13-publish-location-update-to-random-nearby-person-F2B3VI3L.svg)
...
![Image represents a map divided into a grid of nine equal-sized sections, overlaid on a street map showing roads, buildin](./images/6d68c32f_figure-14-nine-geohash-grids-IGQKWUYU.png)
...
![Image represents a system design process for a 'Nearby Friends' feature, depicted as a tree-like structure.  The root no](./images/a139a5c3_chapter-summary-YIHPTBWL.png)
