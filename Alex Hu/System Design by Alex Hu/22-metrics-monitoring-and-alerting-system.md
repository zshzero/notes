...
![Image represents a collection of logos for various monitoring and visualization tools, arranged in two rows.  The top ro](./images/807a5d2d_figure-1-popular-metrics-monitoring-and-alerting-services-TAZBQ5OC.png)
...
![Image represents a high-level diagram of a metrics monitoring and alerting system.  The central component is a rounded r](./images/c33fd880_figure-2-five-components-of-the-system-4UF4TGR7.png)
...
![Image represents a line graph displaying CPU load over time.  The y-axis is labeled 'Percent' and shows values ranging f](./images/0a16c413_figure-3-cpu-load-7S6NAAND.svg)
...
![Image represents a time-series graph visualizing error counts.  The horizontal axis represents time, labeled 'Time' and ](./images/d36257c3_figure-4-data-access-pattern-6W53MWUY.svg)
...
![Image represents a table outlining different resource tiers for a service, likely a database or similar.  The table has ](./images/3c42537e_figure-5-influxdb-benchmarking-THBHSESS.png)
...
![Image represents a system architecture diagram for a metrics monitoring and alerting system.  The system begins with a `](./images/5d2648bd_figure-6-high-level-design-NO6K42P6.svg)
...
![Image represents a system architecture diagram for a metrics monitoring and alerting system.  The diagram shows a 'Metri](./images/03d884b5_figure-7-metrics-collection-flow-AERNBFZG.svg)
...
![Image represents a system architecture for collecting metrics.  A dashed-line box labeled 'Metrics Source' contains four](./images/6e6ab39d_figure-8-pull-model-JCYTADKY.svg)
...
![Image represents a service discovery system using etcd and Zookeeper.  A rectangular box labeled 'Service Discovery' con](./images/e33fe0d0_figure-9-service-discovery-DXWPRSYP.svg)

*Figure 9 Service discovery*

Figure 10 explains the pull model in detail.

![Image represents a system architecture diagram illustrating a metrics collection process.  The diagram shows three main ](./images/23dec235_figure-10-pull-model-in-detail-DLFOSFKN.svg)
...
![Image represents a system architecture diagram showing six services (S1-S6) interconnected in a specific pattern.  Three](./images/dab6b86c_figure-11-consistent-hashing-ZNCJBMK3.png)
...
![Image represents a system for collecting metrics from various sources.  A dashed-line box labeled 'Metrics Source' conta](./images/3f0663b2_figure-12-push-model-BT4OPMTB.svg)
...
![Image represents a system for collecting and distributing metrics.  The system begins with a 'Metrics Source,' specifica](./images/03b06877_figure-13-load-balancer-PRCVTUJJ.svg)
...
![Image represents a system architecture diagram for a metrics monitoring and alerting system.  The system begins with a `](./images/5d8dc764_figure-14-metrics-transmission-pipeline-UCGFUXRF.svg)
...
![Image represents a system architecture diagram for a metrics collection and alerting system.  The left side shows a data](./images/2aeda2df_figure-15-add-queues-X32N6UM5.svg)
...
![Image represents a simplified architecture diagram showing a Metrics Collector sending data to a Kafka message broker.  ](./images/c920f355_figure-16-kafka-partition-YTQUBKKN.svg)
...
![Image represents a system architecture diagram for a metrics monitoring and alerting system.  The left side shows the da](./images/6441ab52_figure-17-cache-layer-QNXQFTQK.svg)
...
![Image represents a diagram illustrating the concept of Double-delta Encoding.  A horizontal timeline is shown, marked at](./images/39eb9456_figure-18-data-encoding-B45QOSIH.svg)
...
![Image represents a system architecture diagram for an alert management system.  The system begins with 'Rule config file](./images/7ca7b310_figure-19-alerting-system-HCBLCMMP.svg)
...
![Image represents a system monitoring three events related to Instance 1's disk usage.  Three rectangular boxes, vertical](./images/ebf0163b_figure-20-merge-alerts-NZGFQ4S3.svg)
...
![Image represents a Grafana dashboard displaying real-time system metrics over the last hour.  The dashboard is titled 'G](./images/d3f26323_figure-21-grafana-ui-NWP2X5V6.png)
...
![Image represents a system architecture diagram for a metrics monitoring and alerting system.  The process begins with a ](./images/76326682_figure-22-final-design-777Y6AAM.svg)
...
![Image represents a mind map outlining the design process for a Metric Monitoring system.  The central node is 'Metric Mo](./images/658b6658_chapter-summary-W7L5LHM3.png)
