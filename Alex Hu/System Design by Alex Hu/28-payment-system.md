...
![Image represents a simplified model of an online transaction on an e-commerce website.  The diagram shows a buyer repres](./images/be402b24_figure-1-simplified-pay-in-and-pay-out-flow-3FEH6LGJ.svg)
...
![Image represents a simplified architecture of a payment system.  A 'Payment event' (1) initiates the process, triggering](./images/5be61594_figure-2-pay-in-flow-5S6II6AU.png)
...
![Image represents a PayPal login page.  At the top, the PayPal logo is displayed prominently. Below the logo, the header ](./images/c8e0181c_figure-3-hosted-pay-with-paypal-page-EZOP6LZ2.png)
...
![Image represents a system diagram illustrating an online payment process.  The process begins at a 'Checkout Page' withi](./images/5feac872_figure-4-hosted-payment-flow-EL5HSZY6.png)
...
- Once the token is persisted, the client displays a PSP-hosted payment page. Mobile applications usually use the PSP’s SDK integration for this functionality. Here we use Stripe’s web integration as an example (Figure 5). Stripe provides a JavaScript library that displays the payment UI, collects sensitive payment information, and calls the PSP directly to complete the payment. Sensitive payment information is collected by Stripe. It never reaches our payment system. The hosted payment page usually needs two pieces of information:
  ...
  ![Image represents a web page displaying an online checkout process for a purchase from a store named 'Powdur'.  The left ](./images/857cde32_figure-5-hosted-payment-page-by-stripe-A4FT5636.png)
...
![Image represents a simplified payment processing system architecture.  A 'Payment event' initiates the process, triggeri](./images/cf8ee118_figure-6-reconciliation-HZKEQ3KA.png)
...
![Image represents a system architecture diagram showing a message queue distributing messages to two services.  A cylindr](./images/1c1a0d8d_figure-7-message-queue-7BXIY252.svg)

*Figure 7 Message queue*

![Image represents a simplified system architecture diagram showing data distribution from a central source to two separat](./images/a5598957_figure-8-single-receiver-for-each-message-OZR5UDDF.svg)
...
![Image represents a system architecture diagram illustrating event processing and distribution.  A circular 'Events' node](./images/efa6963c_figure-9-multiple-receivers-for-the-same-message-FKQDW57G.svg)
...
![Image represents a flowchart depicting a system's handling of failures during payment processing.  The process begins wi](./images/2bac996b_figure-10-handle-failed-payments-ZFR5VAJK.svg)
...
![Image represents a sequence diagram illustrating a client's interaction with a payment system. Two vertical lines repres](./images/16b41ed8_figure-11-retry-SUMHMG67.svg)
...
![Image represents a sequence diagram illustrating idempotency in a payment system.  The diagram is divided into two parts](./images/03312f39_figure-12-idempotency-DC3RCILB.svg)
...
![Image represents a hierarchical tree diagram outlining the design of a Payment Service.  The root node is 'Payment Servi](./images/9ad7a755_chapter-summary-IBDWNX6M.png)
