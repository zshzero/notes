...
![Image represents a simple consistent hashing scheme for distributing keys across four servers.  The top line shows the f](./images/7809209c_figure-5-1-JYB5LSFH.svg)
...
![Image represents a simple consistent hashing scheme for distributing keys across three servers.  The top line shows the ](./images/d2110f85_figure-5-2-25DSOGUM.svg)
...
![Image represents a simplified diagram illustrating data processing or transformation.  A long, rectangular box, represen](./images/e2a3e5e0_figure-5-3-REYWWCBF.svg)

*Figure 3*

By collecting both ends, we get a hash ring as shown in Figure 4:

![Image represents a simplified diagram illustrating a circular buffer or ring buffer data structure.  The circle depicts ](./images/69b9329a_figure-5-4-IYSYQWO7.svg)
...
![Image represents a conceptual diagram illustrating a system of four servers (server 0, server 1, server 2, and server 3)](./images/e01db72d_figure-5-5-4LOAYCHE.svg)
...
![Image represents a circular arrangement of components depicting a system architecture.  A gray circle forms the backbone](./images/3468f32c_figure-5-6-SDSBYUI6.svg)
...
![Image represents a circular arrangement of nodes representing servers and keys, connected by a gray circular path.  Four](./images/85b8eb44_figure-5-7-OIUSEHJP.svg)
...
![Image represents a circular arrangement of nodes representing servers and keys.  Five colored nodes labeled `s0`, `s1`, ](./images/5bef4274_figure-5-8-OBPLVFJF.svg)
...
![Image represents a circular arrangement of nodes connected by a gray arc, representing a ring topology.  Four colored no](./images/28c6e5b3_figure-5-9-NK63F2OI.svg)
...
![Image represents a circular arrangement of four servers (s0, s1, s2, s3) depicted as colored circles, labeled with 's' f](./images/fcd66296_figure-5-10-FCDAIIM2.svg)
...
![Image represents a circular arrangement of servers, depicted as a gray ring with colored nodes representing individual s](./images/5f086496_figure-5-11-BZXRZPW7.svg)
...
![Image represents a system architecture diagram illustrating data flow between two servers (labeled 'server 0' and 'serve](./images/b02a9b2d_figure-5-12-JS3PL6KQ.svg)
...
![Image represents a system architecture diagram showing two servers, labeled 'server 0' (purple) and 'server 1' (cyan), a](./images/1372e555_figure-5-13-EH76K4PV.svg)
...
![Image represents a circular arrangement of nodes representing servers and keys.  Five colored nodes labeled `s0`, `s1`, ](./images/e2e9ec9b_figure-5-14-HZNKA3J3.svg)
...
![Image represents a circular arrangement of nodes connected by a gray arc, representing a ring topology.  Four colored no](./images/99a09a35_figure-5-15-PNWYOYZO.svg)
