...
![Image represents a simplified payment flow diagram.  It shows a 'Bank' component, depicted as a house-shaped box contain](./images/9e560259_figure-1-digital-wallet-UNQ6753B.svg)
...
![Image represents a simplified model of a payment platform.  The diagram shows two square boxes, each labeled 'Digital wa](./images/5c67a921_figure-2-cross-wallet-balance-transfer-2TDVWONK.svg)
...
![Image represents a distributed system architecture for managing wallet balances, illustrating the flow of a transfer com](./images/534009f8_figure-3-in-memory-solution-3RY7RCB4.svg)
...
![Image represents a system design for a wallet transfer functionality.  Two 'Transfer Command' inputs, represented as cir](./images/cec5769e_figure-4-relational-database-L3DEQYTB.svg)
...
![Image represents a two-phase commit protocol for a distributed transaction involving a coordinator (labeled 'Coordinator](./images/0e561619_figure-5-two-phase-commit-W3HB4IJO.svg)
...
![Image represents a simplified system architecture illustrating a distributed transaction involving a coordinator (labele](./images/99406535_figure-6-coordinator-crashes-MTPFFNSD.svg)
...
![Image represents a sequence diagram depicting the 'First Phase' of a distributed transaction, likely the 'Try' phase of ](./images/26df7c91_figure-7-try-phase-PCD3MQ6F.svg)
...
![Image represents a sequence diagram illustrating a two-phase distributed transaction, divided into a 'First Phase' and a](./images/f65c35ed_figure-8-confirm-phase-LJRYUDAO.svg)
...
![Image represents a sequence diagram illustrating a two-phase distributed transaction process with a 'Cancel' outcome in ](./images/ff03e1a4_figure-9-cancel-phase-4VJNJGDS.svg)
...
![Image represents a system architecture for handling transfer commands.  Two identical 'Transfer Command' inputs, represe](./images/b248882b_figure-10-phase-status-table-45KR4FXX.svg)
...
![Image represents a sequence diagram illustrating the 'First Phase' and 'Second Phase: Confirm' of a distributed transact](./images/7c35062b_figure-11-unbalanced-state-ESMXLPTG.svg)
...
![Image represents a system design diagram illustrating a two-phase operation involving a coordinator (labeled 'Coordinato](./images/fb8af8ed_figure-12-out-of-order-execution-OSSZ5U7M.svg)
...
![Image represents a flow diagram illustrating a transaction process with error handling branching. The flow starts from a](./images/c97d5fc1_figure-13-saga-workflow-Y7UCCTUD.svg)
...
![Image represents a system architecture diagram illustrating a command-based state machine.  The process begins with a `C](./images/e57d9160_figure-14-static-view-of-event-sourcing-3BMIV7QG.svg)
...
![Image represents a state machine diagram illustrating a system's behavior over time.  Three horizontal lines represent t](./images/2a9f0d0f_figure-15-dynamic-view-of-event-sourcing-2C2OZVDV.svg)
...
![Image represents a system flow where commands are processed through a queue implemented with Kafka. The process begins w](./images/f13d71ea_figure-16-command-queue-WXJN4Y22.svg)
...
![Image represents a system architecture utilizing command and event queues for processing transactions and maintaining st](./images/54a62f4f_figure-17-how-state-machine-works-67HWC4DZ.svg)
...
![Image represents a system flow involving a 'Command Queue', an 'Event Queue', and 'Historical States'. At the top is a r](./images/e235b6fc_figure-18-reproduce-states-VHMK3NBY.svg)
...
![Image represents a system architecture divided into a 'Write Path' and a 'Read Path', demonstrating a Command Query Resp](./images/47309681_figure-19-cqrs-architecture-KIHA24BO.svg)
...
![Image represents a system architecture diagram illustrating data flow between memory and disk storage.  The top section,](./images/ecfde2ff_figure-20-file-based-command-and-event-storage-LLKHXZ5X.svg)
...
![Image represents a system architecture diagram illustrating data flow and persistence mechanisms.  The top section, labe](./images/a88e6e23_figure-21-file-based-solution-for-command-event-and-state-TBSB5CJG.svg)
...
![Image represents a system architecture diagram illustrating a state machine replicated for read-only access.  The left s](./images/12ceb20c_figure-22-snapshot-2B35C27A.svg)
...
![Image represents a simple diagram illustrating a concept likely related to system status or availability.  The diagram c](./images/76ef355e_figure-23-raft-YUKRLGJR.svg)
...
![Image represents a system architecture diagram illustrating a distributed database system using Raft consensus.  The dia](./images/da766c7b_figure-24-raft-node-group-EFJORSSU.svg)
...
![Image represents a system architecture diagram illustrating a distributed system likely using the Raft consensus algorit](./images/96deb7c2_figure-25-periodical-pulling-CFHWDXCB.svg)
...
![Image represents a system architecture diagram illustrating a distributed system likely using Raft consensus for data re](./images/25c61c54_figure-26-pull-model-with-reverse-proxy-S7JBWCC6.svg)
...
![Image represents a system architecture diagram illustrating a distributed system using Raft consensus for data replicati](./images/6aa3eec0_figure-27-push-model-C7LYOOFM.svg)
...
![Image represents a system architecture diagram illustrating a distributed system using Raft for consensus and handling c](./images/0ef13413_figure-28-final-design-36NRH5KI.svg)
...
![Image represents a system architecture diagram illustrating a distributed transaction processing system using TCC/Saga a](./images/f3c9c64b_figure-29-final-design-in-a-numbered-sequence-RLSHN3GF.svg)
...
![Image represents a system design process for a Digital Wallet, broken down into four steps.  The process begins with def](./images/fb6cef00_chapter-summary-HVK66BBF.png)
