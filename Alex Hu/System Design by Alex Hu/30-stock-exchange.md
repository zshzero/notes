...
![Image represents a world map depicting the locations of major stock exchanges globally, categorized by color-coded regio](./images/66978770_figure-1-largest-stock-exchanges-VOCAUYH7.png)
...
![Image represents a simplified view of the order book for APPLE stock, showing only the best bid and best ask prices and ](./images/f6a85049_figure-2-level-1-data-A5YJ6H3X.svg)

*Figure 2 Level 1 data*

L2 includes more price levels than L1 (Figure 3).

![Image represents a simplified order book for APPLE stock, showing the best bid and ask prices along with their associate](./images/8c7b0824_figure-3-level-2-data-7KGI4YP5.svg)

*Figure 3 Level 2 data*

L3 shows price levels and the queued quantity at each price level (Figure 4).

![Image represents an order book for APPLE stock, showing bid and ask prices with corresponding quantities.  The top secti](./images/dc6a9d6b_figure-4-level-3-data-BSBEFO33.svg)
...
![Image represents a candlestick chart element, specifically a single candlestick, illustrating the price movement of an a](./images/fbbd5440_figure-5-a-single-candlestick-chart-4FUB4O22.svg)
...
![Image represents a system architecture diagram for a stock trading platform.  The diagram shows a client's computer (1) ](./images/ce87ebee_figure-6-high-level-design-A3NJ5JVE.png)
...
![Image represents a simplified architecture diagram of an order processing system.  The central component is the 'Order M](./images/2a58477d_figure-7-inbound_and_outbound_sequencers-3MF75AIL.svg)
...
![Image represents a simplified architectural diagram of a system gateway, depicted as a dashed-line box labeled 'Gateway'](./images/500bd4cf_figure-8-client-gateway-components-COTYQAOK.svg)
...
![Image represents a system architecture diagram for an exchange.  The diagram shows three external entities interacting w](./images/ad2a9ae4_figure-9-client-gateway-W5TCL3VV.svg)
...
![Image represents a simplified architecture diagram for a Market Data Provider (MDP) system.  On the left, a 'Matching En](./images/9f2006e5_figure-10-market-data-publisher-NW4AZKEC.svg)
...
![Image represents a simplified system architecture diagram for order processing and reporting.  The diagram shows an `Ord](./images/410a0555_figure-11-reporter-OKUG5GXU.svg)
...
![Image represents a database schema diagram showing three entities: 'Order', 'Execution', and 'Product'.  The 'Order' ent](./images/89f450c8_figure-12-product-order-execution-CMK5RE7H.png)
...
![Image represents an order book for APPLE stock, showing the buy and sell sides.  The top section, labeled 'Sell book,' d](./images/fbb5041b_figure-13-limit-order-book-illustrated-4HLSPSXB.svg)
...
![Image represents a system design for a buy book order system using a LinkedHashMap and a DoubleLinkedList.  The LinkedHa](./images/f23b24c3_figure-14-place-match-and-cancel-an-order-in-o1-GG4SP5FK.svg)
...
![Image represents a single-server architecture for a trading system.  The diagram shows three main components: 'Order Man](./images/7c016539_figure-15-a-low-latency-single-server-exchange-design-T5ZFOSZB.svg)
...
![Image represents a simplified architecture diagram of an Order Manager system.  The system begins with an 'Input Thread/](./images/f1b43d3e_figure-16-application-loop-thread-in-order-manager-F76ALFG4.svg)
...
![Image represents a comparison of non-event sourcing and event sourcing approaches to data management.  The diagram shows](./images/f6fc611a_figure-17-non-event-sourcing-vs-event-sourcing-J5HGKUDM.svg)
...
![Image represents a system design for an order matching engine.  The system receives FIX (Financial Information eXchange)](./images/ff20215f_figure-18-an-event-sourcing-design-VUZUWA5X.svg)
...
![Image represents a system architecture diagram illustrating data flow in an event-processing pipeline.  At the top, a 'G](./images/ea0ebae4_figure-19-sample-design-of-sequencer-XIKDOBN7.png)
...
![Image represents a system architecture diagram illustrating a two-tiered matching engine design.  A 'Hot' Matching Engin](./images/5ba24922_figure-20-hot-warm-matching-engine-QHSZ5QAN.svg)
...
![Image represents a system architecture diagram for an order matching engine.  At the top, two matching engines are shown](./images/17cc69df_figure-21-event-replication-in-raft-cluster-PVVZDWHT.svg)
...
![Image represents a timeline depicting five terms, labeled 'Term 1' through 'Term 5,' arranged sequentially from left to ](./images/f578102e_figure-22-raft-terms-PGF2N5J6.svg)
...
![Image represents two timelines illustrating different event sequencing.  The top timeline shows six events (labeled 'eve](./images/d044fa62_figure-23-time-in-event-sourcing-ZUOQYUVH.svg)
...
![Image represents a simplified architecture diagram for a system likely involved in financial trading.  On the left, a 'M](./images/a780d0c0_figure-24-market-data-publisher-UJ7LL7ZE.png)
...
![Image represents a hierarchical breakdown of the design process for a Stock Exchange system.  The central node is labele](./images/c7592f74_chapter-summary-KL4KCPJZ.png)
