...
![Image represents a comparison of three different notification methods: push notification, SMS, and email.  The leftmost ](./images/2ebc35e6_figure-10-1-4EEWILYD.svg)
...
![Image represents a simplified architecture diagram illustrating the communication flow between an iOS device, an APNs (A](./images/562ee051_figure-10-2-LRDI5SEA.png)
...
![Image represents a simplified architecture diagram illustrating the flow of information for push notifications.  A circu](./images/dd38a1a5_figure-10-3-5PEUMLEX.png)
...
![Image represents a simplified architecture for sending an SMS message.  A circular node labeled 'Provider' represents th](./images/3c51efc2_figure-10-4-VBM7JWLQ.png)
...
![Image represents a simplified email sending process.  A circular node labeled 'Provider' is connected via a unidirection](./images/d8d2f597_figure-10-5-XJUEYKYB.png)

*Figure 5*

Figure 6 shows the design after including all the third-party services.

![Image represents a system architecture diagram illustrating how a system sends notifications to different platforms usin](./images/75b9023a_figure-10-6-OWRSE4LF.png)
...
![Image represents a simplified system architecture diagram for user contact information storage.  A light-blue box labele](./images/6033aa7e_figure-10-7-W32A7UNW.png)
...
![Image represents a database schema diagram showing a one-to-many relationship between two tables: 'user' and 'device'.  ](./images/b20b1432_figure-10-8-GYVHLNWP.svg)
...
![Image represents a system architecture diagram for a notification system.  Multiple services, labeled 'Service 1,' 'Serv](./images/627fb280_figure-10-9-62C2GFUU.png)
...
![Image represents a system architecture for sending notifications.  Multiple services (Service 1, Service 2... Service N)](./images/116e4b19_figure-10-10-VPOYUWTG.png)
...
![Image represents a simplified architecture for an iOS push notification system.  The diagram shows a leftmost component ](./images/a8da0fd4_figure-10-11-IAFMAASK.svg)
...
![Image represents a line graph depicting a time series data.  The horizontal axis represents time, specifically from appr](./images/f0dfad6d_figure-10-12-WMFNVPQI.svg)
...
![Image represents a state diagram illustrating the lifecycle of a message or notification.  The diagram shows a sequence ](./images/b2ccd9c6_figure-10-13-LUL4UIPV.svg)
...
![Image represents a system architecture diagram for a notification service.  The process begins with 'Service N' sending ](./images/2561f8f7_figure-10-14-XSG2DEDM.png)
