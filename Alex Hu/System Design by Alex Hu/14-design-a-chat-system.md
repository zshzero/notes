...
![Image represents a collection of five popular messaging application logos, each displayed with its corresponding name.  ](./images/9d8c2d2a_figure-12-1-J3Z5T7TL.png)
...
![Image represents a simplified model of a chat application's architecture.  The diagram shows three main components: a 's](./images/f73b2aed_figure-12-2-CA3ZOSQI.png)
...
![Image represents a sequence diagram illustrating the interaction between a Client and a Server regarding message retriev](./images/aceab8f3_figure-12-3-WYSR7WB4.svg)
...
![Image represents a sequence diagram illustrating client-server communication for retrieving new messages.  Two vertical ](./images/802ad05f_figure-12-4-6KL7KY4X.svg)
...
![Image represents a sequence diagram illustrating the WebSocket handshake and communication between a Client and a Server](./images/199f96ae_figure-12-5-VPDI2T2E.svg)
...
![Image represents a simplified architecture of a chat application.  Two rectangular boxes, outlined in light blue, repres](./images/b08b646f_figure-12-6-6UUW2AUS.png)
...
![Image represents a system architecture diagram divided into two main sections: 'Stateless' and 'Stateful'.  The 'Statele](./images/4b445059_figure-12-7-YA7UWFS6.png)
...
![Image represents a system architecture diagram for a real-time communication application.  At the top, a 'User' componen](./images/b4928818_figure-12-8-3R5ORNVB.png)
...
![Image represents a table schema for a database table named 'message'.  The table has five columns: `message_id` (a bigin](./images/fa7356e5_figure-12-9-356WMC2A.png)
...
![Image represents a table schema for a database table named `group_message`.  The table has five columns: `channel_id` (o](./images/464ace8d_figure-12-10-2TIQVS3D.png)
...
![Image represents a system architecture diagram illustrating the flow of a user's login and subsequent connection to a ch](./images/72674ce9_figure-12-11-FGGY42QW.png)
...
![Image represents a simplified chat application architecture.  Two users, User A and User B, represented by smartphone ic](./images/7b4aae25_figure-12-12-5BTRQZRL.png)
...
![Image represents a simplified architecture diagram of a chat application's data flow for a single user (User A).  Two cl](./images/4353ad63_figure-12-13-YB54XAJ3.png)
...
![Image represents a simplified chat application architecture.  A user, labeled 'User A,' sends a message to 'Chat server ](./images/e0cfc94b_figure-12-14-DRZR5QM7.png)
...
![Image represents a simplified chat application architecture.  Two users, User A and User B, are represented by smartphon](./images/3c5d1cdf_figure-12-15-WJ6BSAG2.png)
...
![Image represents a simplified system architecture for tracking user presence.  A mobile device representing 'User A' est](./images/8519a84f_figure-12-16-IUZRWUV6.png)
...
![Image represents a system architecture diagram illustrating a user logout process.  The diagram shows a left-to-right fl](./images/29e9a2f7_figure-12-17-GJTW7H57.png)
...
![Image represents a sequence diagram illustrating a client-server heartbeat mechanism.  Two rectangular boxes labeled 'Cl](./images/7f73b305_figure-12-18-CTDI4PAJ.svg)
...
![Image represents a system architecture diagram illustrating a presence server setup.  A central component, labeled 'Pres](./images/9fe50002_figure-12-19-KY63S3WN.png)
