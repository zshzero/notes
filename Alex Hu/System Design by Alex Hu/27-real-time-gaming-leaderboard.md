...
![Image represents a leaderboard displaying the rankings of four teams in a competition.  The leaderboard is structured as](./images/37c0fa0d_figure-1-leaderboard-NWJTV4ZV.svg)
...
![Image represents a system architecture diagram illustrating the flow of information in a leaderboard system for a game. ](./images/900347cb_figure-2-high-level-design-XQWDCF72.svg)
...
![Image represents two alternative system designs for updating a leaderboard after a game is won.  The 'Current Option' sh](./images/f96096e9_figure-3-who-sets-the-leaderboard-score-O6AIP5UI.svg)
...
![Image represents a system architecture diagram illustrating data flow using Apache Kafka as a message broker.  A 'Game s](./images/6d32fda1_figure-4-game-scores-are-used-by-multiple-services-UWBWILEE.svg)
...
![Image represents a simple database table schema diagram for a leaderboard. The diagram is a rectangular box with a heade](./images/2567a8f7_figure-5-leaderboard-table-WGJD5HTB.png)
...
![Image represents a simplified system architecture diagram showing data flow between a Leaderboard service and a database](./images/283c7c8a_figure-6-a-user-wins-a-point-FN3VKT66.svg)
...
![Image represents a simplified system architecture diagram showing data retrieval for a leaderboard.  A rectangular box l](./images/ad31d226_figure-7-find-a-users-leaderboard-position-6WVQDZK3.svg)
...
![Image represents a simple data flow diagram showing a leaderboard for February 2021.  A rectangular box labeled 'leaderb](./images/bbef7540_figure-8-february-leaderboard-is-represented-by-the-sorted-set-G3APTESM.png)
...
![Image represents a multi-level indexing scheme for a sorted list.  The top section shows a 'Base list' containing the so](./images/79ef5870_figure-9-skip-list-WNOCIURA.svg)
...
![Image represents a directed acyclic graph (DAG) illustrating a data flow or processing pipeline.  The graph consists of ](./images/d7d62756_figure-10-skip-list-with-5-levels-of-indexes-K5QMZDBC.svg)
...
![Image represents a simplified system architecture diagram for a leaderboard service.  The diagram shows three main compo](./images/bd540de7_figure-11-a-user-scores-a-point-XGFZPTLE.png)
...
![Image represents a simplified system architecture diagram showing the interaction between a Leaderboard service and a Re](./images/f31205a7_figure-12-fetch-top-10-global-leaderboard-KOUPGTUC.png)
...
![Image represents a simplified system architecture diagram showing data flow for a leaderboard service.  On the left, a b](./images/7898dbfe_figure-13-fetch-a-users-leaderboard-position-YUJM3G3J.png)
...
![Image represents a leaderboard displaying the rankings of players in a game or competition.  The leaderboard is structur](./images/a7531a59_figure-14-fetch-4-players-above-and-below-DNN7J5ML.svg)
...
![Image represents a system architecture diagram for a leaderboard application.  The diagram shows a user (represented by ](./images/abb1d480_figure-15-manage-our-own-services-T3VHGXIJ.png)
...
![Image represents a system architecture diagram illustrating the process of updating a leaderboard after a game win.  The](./images/71284235_figure-16-score-a-point-TJAYZUVE.png)

*Figure 16 Score a point*

**Use Case 2: retrieving leaderboard**

![Image represents a system architecture diagram illustrating a leaderboard service.  The diagram shows a 'Leaderboard ser](./images/f81e54a7_figure-17-retrieve-leaderboard-4UMUHLST.png)
...
![Image represents a sequence of four rectangular boxes connected horizontally, each representing a sorted set of numbers.](./images/b5d1b20f_figure-18-fixed-partition-2DM4XVL6.svg)
...
![Image represents a Redis Cluster architecture.  At the top, a 'Client' connects to a 'Proxy'. The Proxy then directs req](./images/62a03fc4_figure-19-hash-partition-BNBRIQB7.png)
...
![Image represents a data processing pipeline using a scatter-gather approach.  Three tables, labeled 'shard 0 (top 10)', ](./images/d8089899_figure-20-scatter-gather-KXBJYDNB.png)
...
![Image represents a simplified architecture diagram for a leaderboard service.  The diagram shows four components arrange](./images/e56106c5_figure-21-dynamodb-solution-QSI6N2FT.png)
...
![Image represents a table depicting a database schema or a subset of data from a table.  The table is divided into two ma](./images/40f72e0a_figure-22-denormalized-view-of-the-leaderboard-and-user-tables-PGST2M7Z.png)
...
![Image represents a table depicting a Global Secondary Index with five columns. The first column, labeled 'Partition key ](./images/4a1eae92_figure-23-partition-key-and-sort-key-NMM4PK4Z.png)
...
![Image represents a table depicting a global secondary index.  The table is divided into five columns. The first column, ](./images/510d1ab1_figure-24-updated-partition-key-WDZGBZGP.png)
...
![Image represents a system for generating a top 10 leaderboard from data partitioned across three sources.  Three tables,](./images/0cd43d08_figure-25-scatter-gather-TTZSXIYA.png)
...
![Image represents a mind map outlining the design process for a gaming leaderboard system.  The central node is 'Gaming L](./images/dca89414_chapter-summary-DXV7IGUO.png)
