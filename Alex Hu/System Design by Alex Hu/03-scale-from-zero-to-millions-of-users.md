...
![Image represents a simplified client-server architecture with DNS resolution.  A rounded rectangle labeled 'User' contai](./images/74814821_figure-1-1-WCFZBBLA.png)
...
![Image represents a simplified client-server architecture diagram illustrating the process of accessing a website.  A use](./images/389e0e68_figure-1-2-GPY73ZNO.png)
...
![Image represents a simplified system architecture diagram showing the interaction between a user, a website, and a datab](./images/d8b57764_figure-1-3-2P4MNG7C.png)
...
![Image represents a simplified client-server architecture with load balancing.  A user, accessing via either a web browse](./images/9eac3e26_figure-1-4-2EGRRANZ.png)
...
![Image represents a database replication architecture.  At the top, a cluster of three green boxes labeled 'Web servers' ](./images/c5050f77_figure-1-5-TJLQVE5N.svg)
...
![Image represents a simplified web application architecture.  A user, accessing via a web browser or mobile app, initiate](./images/c432ab98_figure-1-6-L2YNDDKF.png)
...
![Image represents a simplified system architecture illustrating data retrieval from a cache and database.  The diagram sh](./images/6ec0a7dd_figure-1-7-GGNXNZX6.svg)
...
![Image represents a system architecture diagram illustrating a single point of failure.  Three client devices, labeled 'U](./images/68001880_figure-1-8-AVKYQBAQ.png)
...
![Image represents a system architecture diagram illustrating the interaction between clients, a CDN (Content Delivery Net](./images/dbf7e656_figure-1-9-SA7OOP7O.svg)

*Figure 9*

Figure 10 demonstrates the CDN workflow.

![Image represents a system architecture illustrating how a Content Delivery Network (CDN) serves images to users.  Two us](./images/39390af8_figure-1-10-E6HDAMPH.png)
...
![Image represents a system architecture diagram illustrating a typical web application deployment.  The diagram starts wi](./images/20920831_figure-1-11-VI5Z74Q2.png)
...
![Image represents a system architecture diagram showing three separate servers (Server 1, Server 2, Server 3) each handli](./images/bbf351d5_figure-1-12-WTWFBLWX.png)
...
![Image represents a simplified client-server architecture. Three clients, labeled 'User A,' 'User B,' and 'User C,' each ](./images/a01b57f3_figure-1-13-WILHQ2SA.png)
...
![Image represents a system architecture diagram for a web application.  Users access the application via web browsers or ](./images/9204c403_figure-1-14-CCBCQMO6.png)
...
![Image represents a system architecture diagram for a website.  A user, accessing via web browser (www.mysite.com) or mob](./images/622ad088_figure-1-15-GICUI26J.png)
...
![Image represents a system architecture diagram for a website, `www.mysite.com`, and its API, `api.mysite.com`.  Users ac](./images/1ec9cd34_figure-1-16-DUWJTBCU.png)
...
![Image represents a producer-consumer architecture using a message queue.  A rectangular box labeled 'Producer' is connec](./images/9222a9e8_figure-1-17-J2NLNRNY.svg)
...
![Image represents a system architecture diagram illustrating a message queue used for photo processing.  On the left, a g](./images/0cbb79fa_figure-1-18-P3WDK5LN.svg)
...
![Image represents a system architecture diagram for a web application.  A user, accessing via web browser (www.mysite.com](./images/a796c563_figure-1-19-MOPDW7TD.png)
...
![Image represents a comparison between vertical and horizontal scaling in system design.  The diagram is enclosed within ](./images/361c335c_figure-1-20-VLGHMELC.svg)
...
![Image represents a simple data sharding scheme.  A diamond-shaped decision node labeled 'user_id % 4' acts as a routing ](./images/6cf16a2c_figure-1-21-ZDWDWEO5.svg)

*Figure 21*

Figure 22 shows the user table in sharded databases.

![Image represents a database sharding scheme.  Four cylindrical database shards, labeled 'Shard 0,' 'Shard 1,' 'Shard 2,'](./images/7d5928ca_figure-1-22-FI2MHR5M.svg)
...
![Image represents a system architecture diagram for a web application.  A user, accessing via web browser (www.mysite.com](./images/0ffc3f05_figure-1-23-3IYFN6Q6.png)
